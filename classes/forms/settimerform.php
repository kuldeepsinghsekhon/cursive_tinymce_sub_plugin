...
class settimerform extends moodleform {
    public function definition() {
        ...
        $select = $mform->addElement('select', 'quizname', get_string('quizname', 'tiny_cursive'), array(get_string('selectquiz', 'tiny_cursive')), $attributes);
        ...
        $mform->addGroup($radioarray, 'radio', get_string('selecttime', 'tiny_cursive'), array(' '), false);
        ...
        //$mform->addRule('stdtime', get_string('field_required', 'tiny_cursive'), 'required', null, 'client');  
        ...
        $mform->addElement('html', '<div class="alert alert-success time_success" style="display:none;">'.get_string('timesave_success', 'tiny_cursive').'</div>');
        $mform->addElement('html', '<div class="alert alert-success time_successfull" style="display:none;">'.get_string('timesave_success', 'tiny_cursive').'</div>');
